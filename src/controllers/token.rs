...
mod tests {
    ...
    fn test_create_token_request_with_special_chars() {
        let json = r#"{
            ...
            "crate_scopes": ["crate*test", "crate?pattern"]
        }"#;
    ...
    fn test_create_token_response_roundtrip() {
        let original = CreateTokenResponse {
            ...
            crate_scopes: Some(vec!["scope1".to_string(), "scope2".to_string()]),
            endpoint_scopes: Some(vec!["endpoint1".to_string()]),
            expired_at: Some("2025-03-15T10:20:30Z".to_string()),
        };
    ...
    fn test_token_list_item_roundtrip() {
        let original = TokenListItem {
            ...
            revoked: true,
            crate_scopes: Some(vec!["test".to_string()]),
            endpoint_scopes: None,
            expired_at: None,
        };
